...
${footerHtml}
    ...
    if (headingCount >= 2) {
      extraHead += `<link rel="stylesheet" href="${getEmbeddedAssetUrl('gfm_addon_css')}">\n`;
      extraBody += `<script src="${getEmbeddedAssetUrl('gfm_addon_js')}"></script>\n`;
    }
...
<link rel="stylesheet" href="${getEmbeddedAssetUrl('base_css')}">
${extraHead}
<style>
  body {
