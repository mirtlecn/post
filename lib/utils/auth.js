...
export const LEGACY_ADMIN_SESSION_PATH = '/api/admin';
...
function buildAdminLogoutCookieForPath(path) {
...
export function buildAdminLogoutCookie() {
  return buildAdminLogoutCookieForPath(ADMIN_SESSION_PATH);
}

export function buildLegacyAdminLogoutCookie() {
  return buildAdminLogoutCookieForPath(LEGACY_ADMIN_SESSION_PATH);
}

export function buildAdminSessionCookies(sessionId) {
  return [
    buildAdminSessionCookie(sessionId),
    buildLegacyAdminLogoutCookie(),
  ];
}

export function buildAdminLogoutCookies() {
  return [
