...
const ADMIN_NOT_BUILT_HTML = '<!doctype html><html><body style="font-family:sans-serif;padding:32px;"><h1>Admin UI not built</h1><p>Run <code>npm start</code> for a full local boot, or <code>npm run build</code> before <code>npm run start:server</code>.</p></body></html>';
